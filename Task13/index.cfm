<html>
    ...
    <body>
        ...
        <h3>Highlight search keyword:
            ...
            Create a page with text box & submit submit button. 
            If you user gave “the” as input, then you need to show the result as,
            Found the key word in 2 times - the quick brown fox jumps over the lazy dog.
            if input is dog then result should be,Found the key word in 1 time - 
        ...
        <form name="form" id="form" action="" method="post" onsubmit="return validate()">
            ...
            <cfif StructKeyExists(form,"Submitbtn") and StructKeyExists(form,"textbox")>                
                ...
                <cfoutput>
                    Found the string #form.textbox# in the string 
                    "the quick brown fox jumps over the lazy dog" #task13result# times.
                </cfoutput>            
            </cfif> 
          </form>
    </body>
