        ...
        <body>
            <form>
                ...
                <div>
                    ...
                    <button class="checkbtn" onclick="checkdatabase()"><i class="fa fa-check" aria-hidden="true"></i></button>
                    <span  class="errorspan" id="erroremail"></span> 
                </div>
                <div class="submitdiv"><br>
                    <input type="Submit" class="submitbtn" id="submitbtn" name="Submitbtn"  disabled value="Submit">
                </div>   
            </form>        
        </body>
</html>